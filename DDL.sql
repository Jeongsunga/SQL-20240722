...
CREATE USER 'developer'@'192.168.1.3' IDENTIFIED BY 'P!ssw0rd';	  # cmd - ipconfig에서 Ipv4 주소
CREATE USER 'developer'@'%' IDENTIFIED BY 'P!ssw0rd';	# 전체 주소
...
-- 테이블 삭제
-- 만약에 해당 테이블을 참조하고 있는 다른 테이블이 존재하면 테이블 삭제 불가능
